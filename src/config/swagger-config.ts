...
export function setupSwagger(
  ...
  title: string = "Catalog Service API",
  description: string = "API completa para gestión de Catalogs con documentación automática",
  version: string = "1.0"
): string {
try{
  const localPort = String(process.env.PORT || "3000");
      const swaggerConfig = new DocumentBuilder()
        ...
        //.addTag("Catalogs", "Gestión de transacciones y procesamiento de catalogs")
      ...
      const swaggerDocument = SwaggerModule.createDocument(app, swaggerConfig, {
        include: [CatalogModule, /*, AuthModule, ReportsModule*/], // Lista todos los módulos

...
import { LifecycleStatusCreatedEvent } from './lifecyclestatuscreated.event';
import { LifecycleStatusUpdatedEvent } from './lifecyclestatusupdated.event';
import { LifecycleStatusDeletedEvent } from './lifecyclestatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'lifecycle-status-created': createEventDefinition('lifecycle-status-created', LifecycleStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['lifecycle-status-created']),
  'lifecycle-status-updated': createEventDefinition('lifecycle-status-updated', LifecycleStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['lifecycle-status-updated']),
  'lifecycle-status-deleted': createEventDefinition('lifecycle-status-deleted', LifecycleStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['lifecycle-status-deleted']),

...
import { SettlementModeCreatedEvent } from './settlementmodecreated.event';
import { SettlementModeUpdatedEvent } from './settlementmodeupdated.event';
import { SettlementModeDeletedEvent } from './settlementmodedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'settlement-mode-created': createEventDefinition('settlement-mode-created', SettlementModeCreatedEvent, EVENT_DEFINITION_OVERRIDES['settlement-mode-created']),
  'settlement-mode-updated': createEventDefinition('settlement-mode-updated', SettlementModeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['settlement-mode-updated']),
  'settlement-mode-deleted': createEventDefinition('settlement-mode-deleted', SettlementModeDeletedEvent, EVENT_DEFINITION_OVERRIDES['settlement-mode-deleted']),

...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class SettlementModeRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[SettlementMode[], number]> {
      logger.info('Ready to findByField SettlementMode on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of SettlementMode with id:  was finded on repository:', instance);

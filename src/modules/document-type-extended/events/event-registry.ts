...
import { DocumentTypeExtendedCreatedEvent } from './documenttypeextendedcreated.event';
import { DocumentTypeExtendedUpdatedEvent } from './documenttypeextendedupdated.event';
import { DocumentTypeExtendedDeletedEvent } from './documenttypeextendeddeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'document-type-extended-created': createEventDefinition('document-type-extended-created', DocumentTypeExtendedCreatedEvent, EVENT_DEFINITION_OVERRIDES['document-type-extended-created']),
  'document-type-extended-updated': createEventDefinition('document-type-extended-updated', DocumentTypeExtendedUpdatedEvent, EVENT_DEFINITION_OVERRIDES['document-type-extended-updated']),
  'document-type-extended-deleted': createEventDefinition('document-type-extended-deleted', DocumentTypeExtendedDeletedEvent, EVENT_DEFINITION_OVERRIDES['document-type-extended-deleted']),

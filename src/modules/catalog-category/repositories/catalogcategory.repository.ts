...
import { logger } from '@core/logs/logger';
  ...
  export class CatalogCategoryRepository {
    ...
    async findAndCount(where?: Record<string, any>): Promise<[CatalogCategory[], number]> {
      logger.info('Ready to findByField CatalogCategory on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of CatalogCategory with id:  was finded on repository:', instance);

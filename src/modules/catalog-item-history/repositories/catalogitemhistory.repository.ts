...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class CatalogItemHistoryRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[CatalogItemHistory[], number]> {
      logger.info('Ready to findByField CatalogItemHistory on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of CatalogItemHistory with id:  was finded on repository:', instance);

...
import { RiskLevelCreatedEvent } from './risklevelcreated.event';
import { RiskLevelUpdatedEvent } from './risklevelupdated.event';
import { RiskLevelDeletedEvent } from './riskleveldeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'risk-level-created': createEventDefinition('risk-level-created', RiskLevelCreatedEvent, EVENT_DEFINITION_OVERRIDES['risk-level-created']),
  'risk-level-updated': createEventDefinition('risk-level-updated', RiskLevelUpdatedEvent, EVENT_DEFINITION_OVERRIDES['risk-level-updated']),
  'risk-level-deleted': createEventDefinition('risk-level-deleted', RiskLevelDeletedEvent, EVENT_DEFINITION_OVERRIDES['risk-level-deleted']),

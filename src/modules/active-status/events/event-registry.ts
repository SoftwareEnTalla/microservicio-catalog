...
import { ActiveStatusCreatedEvent } from './activestatuscreated.event';
import { ActiveStatusUpdatedEvent } from './activestatusupdated.event';
import { ActiveStatusDeletedEvent } from './activestatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'active-status-created': createEventDefinition('active-status-created', ActiveStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['active-status-created']),
  'active-status-updated': createEventDefinition('active-status-updated', ActiveStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['active-status-updated']),
  'active-status-deleted': createEventDefinition('active-status-deleted', ActiveStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['active-status-deleted']),

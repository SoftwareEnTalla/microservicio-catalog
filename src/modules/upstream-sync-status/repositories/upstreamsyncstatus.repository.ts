...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class UpstreamSyncStatusRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[UpstreamSyncStatus[], number]> {
      logger.info('Ready to findByField UpstreamSyncStatus on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of UpstreamSyncStatus with id:  was finded on repository:', instance);

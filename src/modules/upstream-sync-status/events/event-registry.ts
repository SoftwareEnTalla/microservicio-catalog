...
import { UpstreamSyncStatusCreatedEvent } from './upstreamsyncstatuscreated.event';
import { UpstreamSyncStatusUpdatedEvent } from './upstreamsyncstatusupdated.event';
import { UpstreamSyncStatusDeletedEvent } from './upstreamsyncstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'upstream-sync-status-created': createEventDefinition('upstream-sync-status-created', UpstreamSyncStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['upstream-sync-status-created']),
  'upstream-sync-status-updated': createEventDefinition('upstream-sync-status-updated', UpstreamSyncStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['upstream-sync-status-updated']),
  'upstream-sync-status-deleted': createEventDefinition('upstream-sync-status-deleted', UpstreamSyncStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['upstream-sync-status-deleted']),

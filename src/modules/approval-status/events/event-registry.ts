...
import { ApprovalStatusCreatedEvent } from './approvalstatuscreated.event';
import { ApprovalStatusUpdatedEvent } from './approvalstatusupdated.event';
import { ApprovalStatusDeletedEvent } from './approvalstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'approval-status-created': createEventDefinition('approval-status-created', ApprovalStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['approval-status-created']),
  'approval-status-updated': createEventDefinition('approval-status-updated', ApprovalStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['approval-status-updated']),
  'approval-status-deleted': createEventDefinition('approval-status-deleted', ApprovalStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['approval-status-deleted']),

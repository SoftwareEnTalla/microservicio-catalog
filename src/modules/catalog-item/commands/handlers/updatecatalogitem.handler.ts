...
import { UpdateCatalogItemCommand } from "../updatecatalogitem.command";
import { CatalogItemCommandService } from "../../services/catalogitemcommand.service";

@CommandHandler(UpdateCatalogItemCommand)
export class UpdateCatalogItemHandler
  implements ICommandHandler<UpdateCatalogItemCommand>
{
  constructor(

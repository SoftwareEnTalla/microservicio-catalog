...
import { DocumentTypeCreatedEvent } from './documenttypecreated.event';
import { DocumentTypeUpdatedEvent } from './documenttypeupdated.event';
import { DocumentTypeDeletedEvent } from './documenttypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'document-type-created': createEventDefinition('document-type-created', DocumentTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['document-type-created']),
  'document-type-updated': createEventDefinition('document-type-updated', DocumentTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['document-type-updated']),
  'document-type-deleted': createEventDefinition('document-type-deleted', DocumentTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['document-type-deleted']),

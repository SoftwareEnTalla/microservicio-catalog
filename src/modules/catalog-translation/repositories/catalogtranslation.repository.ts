...
import { logger } from '@core/logs/logger';
  ...
  export class CatalogTranslationRepository {
    ...
    async findAndCount(where?: Record<string, any>): Promise<[CatalogTranslation[], number]> {
      logger.info('Ready to findByField CatalogTranslation on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of CatalogTranslation with id:  was finded on repository:', instance);

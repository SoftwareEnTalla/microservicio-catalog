...
@Module({
  controllers: [CatalogTranslationCommandController],
  providers: [
  ...
  exports: [CatalogTranslationAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthCatalogTranslationModule {}

...
import { CatalogCreatedEvent } from './catalogcreated.event';
import { CatalogUpdatedEvent } from './catalogupdated.event';
import { CatalogDeletedEvent } from './catalogdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'catalog-created': createEventDefinition('catalog-created', CatalogCreatedEvent, EVENT_DEFINITION_OVERRIDES['catalog-created']),
  'catalog-updated': createEventDefinition('catalog-updated', CatalogUpdatedEvent, EVENT_DEFINITION_OVERRIDES['catalog-updated']),
  'catalog-deleted': createEventDefinition('catalog-deleted', CatalogDeletedEvent, EVENT_DEFINITION_OVERRIDES['catalog-deleted']),

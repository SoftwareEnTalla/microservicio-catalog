...
export class CatalogService {
  ...
  // Métodos delegados
  async findAll(options?: any): Promise<Catalog[]> {
  ...
  async findByField(field: string, value: any, page: number, limit: number): Promise<Catalog[]> {
    return this.repository.findByField(field, value, page, limit);
  }

  async findWithPagination(options: any, page: number, limit: number): Promise<Catalog[]> {
  ...
  async update(id: string, partialEntity: Partial<Catalog>): Promise<Catalog | null> {

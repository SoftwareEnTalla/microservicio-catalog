...
import { DeleteCatalogCommand } from "../deletecatalog.command";
import { CatalogCommandService } from "../../services/catalogcommand.service";

@CommandHandler(DeleteCatalogCommand)
export class DeleteCatalogHandler
  implements ICommandHandler<DeleteCatalogCommand>
{
  constructor(
    private readonly commandService: CatalogCommandService
  ) {}
  async execute(command: DeleteCatalogCommand) {

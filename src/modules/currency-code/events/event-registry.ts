...
import { CurrencyCodeCreatedEvent } from './currencycodecreated.event';
import { CurrencyCodeUpdatedEvent } from './currencycodeupdated.event';
import { CurrencyCodeDeletedEvent } from './currencycodedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'currency-code-created': createEventDefinition('currency-code-created', CurrencyCodeCreatedEvent, EVENT_DEFINITION_OVERRIDES['currency-code-created']),
  'currency-code-updated': createEventDefinition('currency-code-updated', CurrencyCodeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['currency-code-updated']),
  'currency-code-deleted': createEventDefinition('currency-code-deleted', CurrencyCodeDeletedEvent, EVENT_DEFINITION_OVERRIDES['currency-code-deleted']),

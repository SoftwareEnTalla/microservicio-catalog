...
@Module({
  controllers: [ActiveStatusExpirableCommandController],
  providers: [
  ...
  exports: [ActiveStatusExpirableAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthActiveStatusExpirableModule {}

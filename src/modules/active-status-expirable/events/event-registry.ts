...
import { ActiveStatusExpirableCreatedEvent } from './activestatusexpirablecreated.event';
import { ActiveStatusExpirableUpdatedEvent } from './activestatusexpirableupdated.event';
import { ActiveStatusExpirableDeletedEvent } from './activestatusexpirabledeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'active-status-expirable-created': createEventDefinition('active-status-expirable-created', ActiveStatusExpirableCreatedEvent, EVENT_DEFINITION_OVERRIDES['active-status-expirable-created']),
  'active-status-expirable-updated': createEventDefinition('active-status-expirable-updated', ActiveStatusExpirableUpdatedEvent, EVENT_DEFINITION_OVERRIDES['active-status-expirable-updated']),
  'active-status-expirable-deleted': createEventDefinition('active-status-expirable-deleted', ActiveStatusExpirableDeletedEvent, EVENT_DEFINITION_OVERRIDES['active-status-expirable-deleted']),

...
import { PermissionEffectCreatedEvent } from './permissioneffectcreated.event';
import { PermissionEffectUpdatedEvent } from './permissioneffectupdated.event';
import { PermissionEffectDeletedEvent } from './permissioneffectdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'permission-effect-created': createEventDefinition('permission-effect-created', PermissionEffectCreatedEvent, EVENT_DEFINITION_OVERRIDES['permission-effect-created']),
  'permission-effect-updated': createEventDefinition('permission-effect-updated', PermissionEffectUpdatedEvent, EVENT_DEFINITION_OVERRIDES['permission-effect-updated']),
  'permission-effect-deleted': createEventDefinition('permission-effect-deleted', PermissionEffectDeletedEvent, EVENT_DEFINITION_OVERRIDES['permission-effect-deleted']),

...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class PermissionEffectRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[PermissionEffect[], number]> {
      logger.info('Ready to findByField PermissionEffect on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of PermissionEffect with id:  was finded on repository:', instance);

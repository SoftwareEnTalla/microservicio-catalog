...
async function bootstrap() {
  ...
  try {
    ...
    logger.info(`ℹCreando instancia del módulo CatalogAppModule...`);
    const app = await NestFactory.create(CatalogAppModule, {
    ...
    const swaggerPath = setupSwagger(
      ...
      "api-docs",
      "Catalog Service API",
      "API completa para gestión de Catalogs con documentación automática",
      "1.0"
    );
